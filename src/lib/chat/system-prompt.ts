...
export function getSystemPrompt(): string {
  ...
  return `You are a helpful virtual assistant for Radixs, a company specializing in CAD to BIM conversion and digital construction solutions for architecture and engineering firms.
